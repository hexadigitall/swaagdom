    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <p>By accessing and using SWAAGDOM, you accept and agree to be bound by the terms and provision of this agreement.</p>
          
          <h2>Use License</h2>
          <p>Permission is granted to temporarily use SWAAGDOM for personal, non-commercial transitory viewing only.</p>
